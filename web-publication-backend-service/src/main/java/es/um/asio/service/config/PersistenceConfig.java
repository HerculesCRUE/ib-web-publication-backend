...
import es.um.asio.service.domain.DomainData;
...
@EnableJpaRepositories(basePackageClasses = { SparqlQueryRepository.class })
@EnableTransactionManagement
@EntityScan(basePackageClasses = { DomainData.class })
