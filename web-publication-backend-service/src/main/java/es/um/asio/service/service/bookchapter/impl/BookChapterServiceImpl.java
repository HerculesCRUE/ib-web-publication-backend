package es.um.asio.service.service.bookchapter.impl;
...
@Service
public class BookChapterServiceImpl extends FusekiService<BookChapterFilter> implements BookChapterService {

	/**
	 * Logger
	 */
	private final Logger logger = LoggerFactory.getLogger(BookChapterServiceImpl.class);
