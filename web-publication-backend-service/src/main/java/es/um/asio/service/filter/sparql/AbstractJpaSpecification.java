...
public abstract class AbstractJpaSpecification<T> implements Specification<T> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5786005895993678504L;
	 ...
	 * @param entityProperty  Entity's property (attribute) which forms left part of
	 *                        the comparision
	 * @param filter          Right part of the comparision.
	 * @return Predicate.
	 */
	...
	/**
	 * Create an contains ignore case {@link Predicate}. Gets the rows containing
	 * the filter string in some part of the column specified by entity proprety.
	 *
	 * @param root            Query root
	 * @param criteriaBuilder Criteria builder
	 * @param entityProperty  Entity's property (attribute) which forms left part of
