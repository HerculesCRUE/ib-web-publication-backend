package es.um.asio.service.service.funding.impl;
...
@Service
public class FundingServiceImpl extends FusekiService<FundingFilter> implements FundingService {

	/**
	 * Logger
	 */
	private final Logger logger = LoggerFactory.getLogger(FundingServiceImpl.class);
